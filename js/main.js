...
$(".random").on('click', function () {
  ...
  do {
    ...
    let selector = ".bingo-card__item:nth-child(" + i + ")";
...
$(".random2").on('click', function () {
  ...
  var a = $('.bingo-card__item:not(".active")');
  var arr = Object.keys(a).filter(value => !isNaN(value));

  var i = Math.floor(Math.random() * arr.length);
  // $(".bingo-card__item:nth-child(" + i + ")").addClass('active');
  // a.get(i).addClass('active');
  a[arr[i]].classList.add("active")
  console.log(arr);
  console.log(i);

  // Object.keys(a).some(function (value) {
  //   console.log(value);
  //   if (!Number.isNaN(value)) {
  //   // if (Number.isInteger(value)) {
  //     var v = Number.parseInt(value) + 1;
  //     $(".bingo-card__item:nth-child(" + v + ")").addClass('active');
  //     console.log(v);
  //     return true;
  //   }
  // });
